...
const coverLetter = props => {
  return (
    <section id="cover-letter" className="section__intro">
      ...
      <p>
        Since I was young, I&#39;ve always been enamored by function, structure
        &amp; design. From Legos to diagrams to my forays into Basic, form and
        function needed to work together in a streamlined way to achieve what I
        envisioned. Add to that my intrigue in getting systems to run
        efficiently - and I was having fun.
      </p>
      <p>
      ...
      <p>
        ...
        closely with my employers &amp; clients - working to understand how they
        do business and what their goals are for the project. I handle projects
        as if they were for my own goals.
      </p>
      <p>
